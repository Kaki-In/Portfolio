...
import { ProjectSkillThumbnail } from "./ProjectSkillThumbnail.js";

export class ProjectSkillsSection extends Component
{
    constructor(name, skills, local_user, notifications, switch_history)
    {
        let { div, title, content_div } = createProjectSkillsSection();
        super(div);
    ...
    {
        appendChild(this._content, new ProjectSkillThumbnail(skill, local_user, notifications, switch_history));
    }

}

function createProjectSkillsSection()
{
